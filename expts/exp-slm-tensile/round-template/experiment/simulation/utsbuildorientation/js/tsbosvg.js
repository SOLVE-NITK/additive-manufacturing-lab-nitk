...
var t = 6;
var z,sw,v,n,frac;
var n,n1 = 0,n2=1,n3,n4=1,x,y,l,x1,y1,l1;
...
function layerrepeat() {
    ...
    if (repeat==2) {
        ...
        document.getElementById('base22').setAttribute('d',"m 10, 124 h 24 v 256 h 420 v -256 h 8 v 250 h 82.5 v -250 h 17.5 v 276 h-552 v-276");
        document.getElementById('base22').style.strokeWidth = 1;
        document.getElementById('base22').setAttribute('class','drawmainbase');
        console.log(document.getElementById('base22'));
        document.getElementById('base12').setAttribute('d',"m34.5 "+((370)+(1.5/2)+(0.5/2))+"h419 v7 h-205 v2 h-10 v-2 h10 h-214 v-7 l0.5, 0.5 h418 v6 h-418 v-6");
        document.getElementById('base12').style.strokeWidth = 0.5;
        console.log(document.getElementById('base12'));
        document.getElementById('base12').setAttribute('class','drawbase');
        document.getElementById('specimen2').setAttribute('class','svg2');
        var id6 = 'baseroller'+(repeat)+'';
        var path2=document.createElementNS(svgNS,"path");
        specimen2.appendChild(path2);
        path2.setAttributeNS(null,'id',id6);
        document.getElementById(id6).setAttribute('d',"m462.5 124 h81.5 v5 h-38.25 v 245 h-5 v-245 h5 h-43.25 v-5 l0.5, 0.5 h80.5 v4 h-80.5 v-4");
        document.getElementById(id6).style.strokeWidth = 0.5;
        document.getElementById(id6).setAttribute('class','drawbase');
        document.getElementById(id6).style.visibility="visible";
        document.getElementById(id6).style.zIndex = repeat+1;
        document.getElementById('roller').style.top = ""+(148)+"px";
        document.getElementById('roller').style.left = ""+(721)+"px";

        for(n = 0; n < 164; n++){  
            var id8 = 'materialhidden'+(n+1)+''+(repeat)+'';    
            var path3=document.createElementNS(svgNS,"path");
            specimen2.appendChild(path3);
            path3.setAttributeNS(null,'id',id8);
            path3.setAttributeNS(null,'fill',"none");
            document.getElementById(id8).setAttribute('d',"M34.5,"+(370-((n)*sw))+" l419 0.001");
            document.getElementById(id8).style.strokeWidth = sw;
            document.getElementById(id8).setAttribute('class','drawroller');
            document.getElementById(id8).style.visibility="visible";
            document.getElementById(id8).style.zIndex = n;
            console.log(document.getElementById(id8));
        }
        for (n = 1; n < 36; n=n+2) {
            var id4 = 'layerrepeat'+(n1+1)+''+repeat+'';
            x = 118-n*(sw/2)*Math.tan(toRadians(45));
            y = 370 - n1*sw;
            n1 = n1+1;
            l = n*(sw/2)*(Math.tan(toRadians(45))+Math.tan(toRadians(45)));
        ...
        for (n2 = 1; n2 < 129; n2=n2+1) {
            var id4 = 'layerrepeat'+(n1+n2)+''+repeat+'';
            x1 = x + (n2*sw/(Math.tan(toRadians(45))));
            y1 = y - n2*sw;
            l1 = l;
            var path=document.createElementNS(svgNS,"path");
            specimen2.appendChild(path);
            ...
            document.getElementById(id4).setAttribute('class','draw');
            if (n2==128) {
                console.log('layersecondloop is',document.getElementById(id4));
            }
        }
        console.log('x2=',x1,'y2=',y1,'l2=',l1);
        for (n3 = 35; n3 > 0; n3=n3-2) {
            var id4 = 'layerrepeat'+(n1+n2+n4-1)+''+repeat+'';
            var x2 =  x1 + (n4*sw/(Math.tan(toRadians(45))));
            var y2 = y1 - n4*sw;
            n4 = n4+1;
            var l2 = n3*(sw/2)*(Math.tan(toRadians(45))+Math.tan(toRadians(45)));
            var path=document.createElementNS(svgNS,"path");
            specimen2.appendChild(path);
            path.setAttributeNS(null,'id',id4);
            path.setAttributeNS(null,'fill','none');
        ...
        document.getElementById('base23').setAttribute('d',"m 10,60 h 24 v 340 h 420 v -340 h 8 v 340 h 82.5 v -340 h 17.5 v 350 h-552 v-350");
        document.getElementById('base23').style.strokeWidth = 1;
        console.log(document.getElementById('base23'));
        document.getElementById('base23').setAttribute('class','drawmainbase');
        document.getElementById('base13').setAttribute('d',"m34 "+((390)+(0.8/2)+(0.5/2))+"h420 v7 h-205 v2.35 h-10 v-2.35 h10 h-215 v-7 l0.5, 0.5 h419 v6 h-419 v-6");
        document.getElementById('base13').style.strokeWidth = 0.5;
        console.log(document.getElementById('base13'));
        document.getElementById('base13').setAttribute('class','drawbase');
        document.getElementById('specimen2').setAttribute('class','svg3');
        document.getElementById('specimen').style.visibility='hidden';
        document.getElementById('specimen2').style.visibility='visible';
        document.getElementById('roller').style.top = ""+(68)+"px";
        document.getElementById('roller').style.left = ""+(721)+"px";
        for(n = 0; n < 413; n++){  
            var lh = 0.4;
            var sw = 0.8; 
            var id8 = 'materialhidden'+(n)+''+(repeat)+'';    
            var path3=document.createElementNS(svgNS,"path");
            specimen3.appendChild(path3);
            path3.setAttributeNS(null,'id',id8);
            path3.setAttributeNS(null,'fill',"none");
            document.getElementById(id8).setAttribute('d',"M34.5,"+(390-((n)*sw))+" l419 0.001");
            document.getElementById(id8).style.strokeWidth = sw;
            document.getElementById(id8).setAttribute('class','drawroller');
            document.getElementById(id8).style.visibility="visible";
            document.getElementById(id8).style.zIndex = n;
            ...
            var path=document.createElementNS(svgNS,"path");
            specimen3.appendChild(path);
            path.setAttributeNS(null,'id',id4);
            path.setAttributeNS(null,'fill','none');
            document.getElementById(id4).setAttribute('d',"M234, "+(390-n*(sw))+" l20 0.001");
            document.getElementById(id4).style.strokeWidth = sw;
            document.getElementById(id4).style.zIndex = n+1;
            document.getElementById(id4).style.strokeLinecap = 'round';
            document.getElementById(id4).style.stroke = "url(#myGradient)";
        ...
        var id6 = 'baseroller'+(repeat)+'';
        var path2=document.createElementNS(svgNS,"path");
        specimen3.appendChild(path2);
        path2.setAttributeNS(null,'id',id6);
        document.getElementById(id6).setAttribute('d',"m462.5 60 h81.5 v5 h-38.25 v345 h-5 v-345 h5 h-43.25 v-5 l0.5, 0.5 h80.5 v4 h-80.5 v-4");
        document.getElementById(id6).style.strokeWidth = 0.5;
        document.getElementById(id6).setAttribute('class','drawbase');
        document.getElementById(id6).style.visibility="visible";
        document.getElementById(id6).style.zIndex = repeat+1;
