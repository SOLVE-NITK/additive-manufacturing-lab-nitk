...
var ca;
var questions=["Very high laser power </br>can lead to _____.",
				"Very less laser power <br>can lead to which defect?",
				"Gas entrapped pores are a result of low laser power."];

var options2=[["Evaporation of powder","Wastage of energy","All the above"],//All the above
			  ["Cracks","Lack-Of-Fusion","Porosity defects"],//Lack-Of-Fusion
			  ["True","False"]];//False
				...
				$('#red').click(function()
				{
					...
					setTimeout(function()
    				{
    				    if (repeat==1) {
    				        setTimeout(function()
    				        {
    				            validateAnswer(0,2,"550px","340px");
    				        },500);
    				    }
    				    else if (repeat==3) {
    				        setTimeout(function()
...
function magic()
{
	...
	if (simsubscreennum==1)
	{
		...
		document.getElementById('arrow1').style.visibility='hidden';
		document.getElementById('nextButton').style.visibility="hidden";
        document.getElementById('can6-2').innerHTML="Laser power = " +tensilevalues[repeat-1][0] +" W";
        document.getElementById('power').innerHTML= tensilevalues[repeat-1][0];
...
function checkInference()
{
	...
	{
		document.getElementById("ans").innerHTML="Wrong! Ultimate tensile strength increases with increase in laser power.";
	}

	setTimeout(function()
	{
		document.getElementById("inference").style.visibility="hidden";
		document.getElementById("infAns").innerHTML="With more laser power, higher energy is available to melt the powder completely, so that the fusion of material during solidification is more efficient. This leads to more strength.";
		$("#infAns").fadeIn(750);
	},1000);
}
