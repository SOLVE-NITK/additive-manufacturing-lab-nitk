...
var impactjoulevalues=[[0,0],[0,0],[0,0],[0,0]];
...
function magic()
{
	...
	if (simsubscreennum==1)
	{
		...
		if(flag==1)
		{
		    ...
		    document.getElementById('arrow1').style.visibility='hidden';
		    document.getElementById('nextButton').style.visibility="hidden";
		    document.getElementById('can6-2').innerHTML="Build orientation = " +impactvalues[repeat-1][0] +"°";
		    document.getElementById('bo').innerHTML= impactvalues[repeat-1][0];
		    document.getElementById('can6-4').innerHTML="Infill density = " +100  +" %";
		    document.getElementById('can6-5').innerHTML="Raster angle = "+0+"°/"+90+"°" ;
...
function refresh3()
{
	if (repeat==2)
	{
	    ...
	    document.getElementById('drawlayer11').style.visibility = "hidden";
        document.getElementById('drawlayer12').style.visibility = "hidden";
        document.getElementById('drawlayer13').style.visibility = "hidden";
	    document.getElementById('drawlayer14').style.visibility = "hidden";
        document.getElementById('drawlayer15').style.visibility = "hidden";
		for (let index = 0; index < (Math.round(4/0.3)); index++)
		{
	...
	if (repeat==4)
	{
		...
		{
            document.getElementById("support"+(index)+""+(repeat-1)+"").style.visibility="hidden";
        }
		for (let index = 0; index < 6; index++)
		{
            document.getElementById("support"+(index+231)+""+(repeat-1)+"").style.visibility="hidden";
        }
...
function checkInference()
{
	...
	{
		document.getElementById("ans").innerHTML="Wrong! Impact strength increases upto 30° build orientation then decreases.";
	}
	setTimeout(function()
	{
		document.getElementById("inference").style.visibility="hidden";
		document.getElementById("infAns").innerHTML="At 0°, the print fibres are perpendicular to the cross-section at which hammer strikes. Upto 30°, this arrangement helps in resisiting more force from the hammer. After 30°, the print fibres become more and more parallel to the cross-section at which hammer hits, thus reducing the impact strength.";
		$("#infAns").fadeIn(750);
	},1500);
}
