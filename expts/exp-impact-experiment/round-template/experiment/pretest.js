...
// Write your MCQs here --- Start --- --------------------
  ...
  const myQuestions = [
    ...
    {
      question: "Notch is facing the striking pendulum in which test?",
      answers: {
        a: "Charpy test",
        b: "Izod test"
      },
    ...
    {
        question: "Impact strength is measured as ratio of loss of energy during hammer transit to",
    answers: {
          a: "Original cross-section area",
          b: "Cross section area under the notch"
        },
        correctAnswer: "b"
      }
  ];
