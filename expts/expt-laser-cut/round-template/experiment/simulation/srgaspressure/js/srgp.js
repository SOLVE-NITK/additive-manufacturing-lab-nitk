...
var gaspressurevalues = [[7.5,2.28],[10,1.87],[12.5,1.46],[15,1.05]];
console.log('gaspressurevalues=',gaspressurevalues);
p1="";
p2="";
p3="";
p4="";
...
var ca;
var questions=["Assist gas pressure _______ with increase<br> in material thickness.",
				"What range of nitrogen pressure(in bar)<br> is usually used?",
				"Processing speed for nitrogen assisted cutting <br>is _____ than that of oxygen assisted cutting."];

var options2=[["Increases","Decreases","Stays the same"],//Increases
			  ["5-50","10-20","50-100"],//10-20
...
function magic()
{
	...
	if (simsubscreennum==1)
	{
		...
		document.getElementById('gaspressure').innerHTML= gaspressurevalues[repeat-1][0];
		document.getElementById('can6-1').innerHTML="Assist gas pressure = "+gaspressurevalues[repeat-1][0] +" bar";
		document.getElementById('can6-4').innerHTML="Cutting speed  = "+2000  +" mm/min" ;
		...
		console.log('flagis0');
		console.log('value is',gaspressurevalues);
		document.getElementById('nextButton').style.visibility="hidden";
		document.getElementById('can6-3').innerHTML="Laser power = " +1.5+" KW";
		document.getElementById('gaspressure').innerHTML= gaspressurevalues[repeat-1][0];
		document.getElementById('can6-1').innerHTML="Assist gas pressure = "+gaspressurevalues[repeat-1][0] +" bar";
                ...
                document.getElementById("sheet2").onclick=function()
			    {
                    ...
                    document.getElementById("machineopensheet").onclick=function()
                    {
					   ...
					   if (repeat==1) {
						setTimeout(function()
							{
								validateAnswer(0,0,"50px","180px");
							},500);
						}
						else if (repeat==3) {
						setTimeout(function()
						{
							validateAnswer(1,1,"50px","180px");
						},500);
						}
						else if (repeat==4){
						setTimeout(function()
						{
							validateAnswer(2,1,"50px","180px");
						},500);
						}
						else {
						document.getElementById('nextButton').style.visibility="visible";
		...
		document.getElementById("probe1").onclick=function()
		{
			...
			document.getElementById("device").onclick=function()
			{
				...
				document.getElementById('probe').addEventListener("animationend",()=>{
					document.getElementById('dispres').innerHTML =""+(gaspressurevalues[repeat-1][1])+"";
					document.getElementById('dispres').style.visibility="visible";
					document.getElementById('sr1').style.visibility="hidden";
					document.getElementById('sr2').innerHTML ="Surface Roughness of specimen = "+gaspressurevalues[repeat-1][1]+" &#181m";
	...
	else if (simsubscreennum==5)
	{
		...
		document.getElementById('1-1').innerHTML=gaspressurevalues[0][0];
		document.getElementById('2-1').innerHTML=gaspressurevalues[1][0];
		document.getElementById('3-1').innerHTML=gaspressurevalues[2][0];
		document.getElementById('4-1').innerHTML=gaspressurevalues[3][0];
        document.getElementById('1-2').innerHTML=gaspressurevalues[0][1];
        document.getElementById('2-2').innerHTML=gaspressurevalues[1][1];
        document.getElementById('3-2').innerHTML=gaspressurevalues[2][1];
        document.getElementById('4-2').innerHTML=gaspressurevalues[3][1];
...
function checkInference()
{
	...
	{
		document.getElementById("ans").innerHTML="Wrong! Surface roughness decreases with increase in assist gas pressure";
	}

	setTimeout(function()
	{
		document.getElementById("inference").style.visibility="hidden";
		document.getElementById("infAns").innerHTML="Increased assist gas pressure leads to cleaning of molten material from the cut surface and also cooling of HAZ. This leads to smoother specimens.";
		$("#infAns").fadeIn(750);
	},1000);
}
